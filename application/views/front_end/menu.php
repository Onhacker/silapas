...
<div id="navigation">
  <ul class="navigation-menu">
    ...
    <li class="has-submenu <?= ($uri === 'hal/jadwal') ? 'active-menu' : '' ?>">
      <a href="<?= site_url('hal/jadwal'); ?>"><i class="fe-clock"></i> Jadwal Kunjungan</a>
    </li>
    <li class="has-submenu <?= ($uri === 'hal/struktur') ? 'active-menu' : '' ?>">
      <a href="<?= site_url('hal/struktur'); ?>"><i class="fe-share-2"></i> Struktur Organisasi</a>
    </li>
    <li class="has-submenu <?= ($uri === 'hal/alur') ? 'active-menu' : '' ?>">
      <a href="<?= site_url('hal/alur'); ?>"><i class="fe-shuffle"></i> Alur Kunjungan</a>
    </li>
