               ...
               <!--  <?php if ($record->tanggal_reg == "0000-00-00"){ ?>
                ...
                <?php } else { ?> -->
                    ...
                    <div class="text-left mt-3">
                       ...
                       <p class="text-black mb-2 font-13"><strong>No. Whatsapp :</strong><span class="ml-2"><?php echo $record->no_telp ?></span></p>
                       
                        <p class="text-black mb-1 font-13"><strong>Tanggal Reg :</strong> <span class="ml-2"><?php echo tgl_indo($record->tanggal_reg) ?></span></p>
                    </div>
...
<?php $this->load->view("Faskes_profil_js") ?>
