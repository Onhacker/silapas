<script type="text/javascript">
     $(document).ready(function(){
        ...
        table = $('#datable_2').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "<?php echo site_url(strtolower($controller)."/get_data_modul_capil/".$this->uri->segment(3) )?>", "type": "POST"},
            columns: [
    ...
    function pub(id,ses){
        ...
        $.ajax({
            type: "POST",
            url : "<?php echo site_url(strtolower($controller).'/pub_capil')?>/" + id + "/" + ses,
            cache : false,
            dataType: "json",
