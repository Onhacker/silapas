<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        table = $('#datable_1').DataTable({
            ...
            serverSide: true,
            responsive: true,
            ajax: {"url": "<?php echo site_url(strtolower($controller)."/get_data_capil")?>", "type": "POST"},
    ...
    function simpan(){
        var url;
        if(save_method == 'add') {
            url = "<?php echo site_url(strtolower($controller).'/add_capil')?>/";
        } else {
            url = "<?php echo site_url(strtolower($controller).'/update_capil')?>/";
        }   
        ...
        success: function(result){
            ...
            if (obj.success == false ){
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        document.location.href = "<?php echo site_url(strtolower($controller)."/detail_profil_capil/") ?>" + obj.id;
                    } else {
    ...
    function det(id){
        document.location.href = "<?php echo site_url(strtolower($controller)."/detail_profil_capil/") ?>" + id;
    }
